// AI 情报站 — 数据文件（由 scripts/update-data.mjs 自动生成于 2026-09-14）
...
export const news = [
  {
    ...
    "desc": "IT之家 9 月 14 日消息，据路透社报道，埃隆 · 马斯克（Elon Musk）旗下的 X 公司与 SpaceXAI 于周一宣布，已在得克萨斯州联邦法院撤回针对苹果公司的诉讼。该诉讼此前指控苹果合谋非法垄断智能手机以…",
    "source": "IT之家",
    "url": "https://www.ithome.com/1/002/314.htm"
  },
  {
    "date": "2026-09-14",
    "title": "英伟达：Perplexity 本地智能体 Portable Computer 已向 Windows RTX PC 开放",
    "desc": "IT之家 9 月 14 日消息，英伟达宣布，Perplexity 的本地智能体平台“Portable Computer”现已面向 Windows RTX PC 用户开放。随着本地大模型能力持续增强，AI 智能体可以直接在…",
    "source": "IT之家",
  ...
  },
  {
    ...
    "desc": "通过这场大赛，蚂蚁灵波希望将 LingBot-VLA 进一步推向更广泛的开发者社区和高校科研社区",
    "source": "量子位",
...
export const trending = [
  ...
  },
  {
    ...
    "today": 52,
    "stars": 1880,
    "desc": "Hermès Agent编码智能、长期⚚记忆系统和模型优化工作流程包的一体化插件"
  },
  {
  ...
  },
  {
    ...
    "today": 110,
    "stars": 67447,
    "desc": "用Rust编写的非官方Bitwarden兼容服务器，以前称为bitwarden_rs"
  }
];
